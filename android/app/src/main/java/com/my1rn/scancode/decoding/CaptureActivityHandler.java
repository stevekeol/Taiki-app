...
import com.my1rn.scancode.ui.view.ViewfinderResultPointCallback;
        ...
        switch (message.what) {
            ...
            case Ids.launch_product_query:
                ...
                if (resolveInfo != null && resolveInfo.activityInfo != null) {
                    ...
                    Log.d("Scancode", "Using browser in package " + browserPackageName);
                }
                ...
                try {
                    ...
                    Log.d("Scancode", "Can't find anything to handle VIEW of URI " + url);
                }
                break;
        }
    }
